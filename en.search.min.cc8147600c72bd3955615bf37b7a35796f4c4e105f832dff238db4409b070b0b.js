...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f064ffedc6191173e56a3f406f4a7b8ffc76a12cc6af03ccd06942d3e881bda1.js',function(){input.required=false;search();});}
